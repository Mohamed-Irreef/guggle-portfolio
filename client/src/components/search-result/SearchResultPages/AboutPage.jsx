...
const data = [
  ...
  },
  {
    ...
    navTitle2: "https://instagram.com › mohamed_ireef",
    heading: "Mohamed Irreef (@mohamed_ireef)",
  ...
  },
  {
    ...
    navTitle2: "https://mohamedireef.dev",
    heading: "Personal Portfolio Website",
    para: "A personal Google-style portfolio featuring modern animations, search-based navigation, and responsive UI. Built using React, Tailwind, and Framer Motion to simulate a search engine experience.",
    link: "https://mohamedireef.dev"
  }
];
...
const accordianItems = [
  ...
  },
  {
    ...
    content:
      "Yes, he shares creative insights and personal moments on Instagram under the handle @mohamed_ireef. His feed includes web design ideas, coding snippets, and motivational posts for developers."
  },
  {
            ...
            <div className="addition-grid-container">
              ...
              <div className="add-grid-top">
                ...
                <div className="add-grid" style={{padding:"20px"}}>
                  <span>Age</span>
                  <div className="">
                    <p className="age-dynamic" style={{marginTop:"40px",fontSize:"17px", fontWeight:"400"}}>{age} years</p>
                    <p className="dob" style={{marginTop:"2px", fontSize:"12px"}}>16 March 2004</p>
                  </div>
                </div>
                ...
                <div className="add-grid add-grid-box">
                  <div className="add-grid-left">
                    ...
                    <div className="add-grid-left-content">
                      ...
                      <span>Full Stack Developer</span>
                      <span style={{color:"#5a5a5aff",fontSize:"12px",marginTop:"2px"}}>2.5k+ followers</span>
                    </div>
                    <a  href='https://www.linkedin.com/in/-mohamed-ireef-s-23-/' className='add-grid-left-profile'>Linkedin Profile</a>
                  </div>
              ...
              <div className="add-grid-bottom">
                <div className="add-grid" style={{padding:"20px"}}>
                  <span style={{marginTop:"40px",fontSize:"17px", fontWeight:"400"}}>Education</span>
                  <br /> <br />
                  <a href='https://sairam.edu.in/' className='anchor' style={{marginTop:"10px", fontSize:"14px"}}>Sri Sairam Engineering College</a>
                  <p style={{marginTop:"2px", fontSize:"10px"}}>BE Electronics And Communication Engineering</p>
                  <p style={{marginTop:"2px", fontSize:"14px"}}>2022 - 2026</p>
                </div>
                <div className="add-grid add-grid-box">
                   <div className="add-grid-left">
                    <div className="add-grid-left-nav">
                    ...
                    <div className="add-grid-left-content">
                      <p className='add-grid-left-name'>Mohamed Irreef</p>
                      <span>Full Stack Developer</span>
                      <span style={{color:"#5a5a5aff",fontSize:"12px",marginTop:"2px"}}>30+ followers</span>
                    </div>
                    <a href='https://github.com/Mohamed-Irreef' className='add-grid-left-profile'>GitHub Profile</a>
                  </div>
                  <div className="add-grid-right">
                    <img src={profile3} alt="" />
                  </div>
        ...
        <div className="about-contents-container">
          ...
          <div className="about-page-right-content">
            ...
            <p className='about-page-right-content-para'>
              Mohamed Irreef is a certified full-stack web developer, educator, and innovator passionate about modern web technologies. Known for his expertise in MERN stack development (MongoDB, Express.js, React.js, Node.js), he also works with Java and MySQL to build scalable backend systems. He has also developed several impactful projects, including LMS Platform, StockFlow Warehouse Management System, and an E-commerce platform for local shopkeepers. He is also an avid chess player, known for his strategic thinking and problem-solving skills. <a className='anchor' href=''>wikipedia</a>

            </p>
            <ul className='about-page-right-content-para-list'>
              <li><b>Born:</b> 16 March 2004 (age {age} years), Tuticorin</li>
              <li><b>College:</b> <a className='anchor' href="https://sairam.edu.in/">Sri Sairam Engineering College</a></li>
              <li><b>Department:</b> Electronics And Communication Engineering</li>
              <li><b>CGPA:</b> 8.11 &nbsp; &nbsp; <b>Batch:</b> 2022-2026</li>
              <li><b>School:</b><a className='anchor' href="https://www.justdial.com/Chennai/Zigma-Matriculation-School-Near-Super-Auto-Pvt-Ltd-Medavakkam/044P4003472_BZDET">Zigma Matriculation Higher Secondary School</a></li>
              <li><b>HSC:</b> 90.5% &nbsp; &nbsp; <b>SSLC:</b> 85%</li>
            </ul>

            <div className="about-border"></div>
            <div className="about-page-right-content-para-profile">
              <p className='about-page-right-content-title' style={{marginTop:"20px"}}>Profiles</p>

              <div className="about-page-right-content-profile-container">
                <a className='anchor' href="https://www.linkedin.com/in/-mohamed-ireef-s-23-/">
                  <div className="about-page-right-content-profile-box">
                  <div className="profile-box-logo"><img src={linkedinCircle} alt="" /></div>
                  <span>Linkedin</span>
                </div>
                </a>
                <a className='anchor' href="https://github.com/Mohamed-Irreef">
                  <div className="about-page-right-content-profile-box">
                   <div className="profile-box-logo"><img src={github} alt="" /></div>
                  <span>GitHub</span>
                </div>
                </a>
                <a className='anchor' href="https://www.instagram.com/scratch_2_deploy?igsh=c2J2N3JybjFpdmFz">
                  <div className="about-page-right-content-profile-box">
                   <div className="profile-box-logo"><img src={insta} alt="" /></div>
                  <span>Instagram</span>
                </div>
                </a>
                <a className='anchor' href="https://www.facebook.com/profile.php?id=61577158546081">
                  <div className="about-page-right-content-profile-box">
                   <div className="profile-box-logo"><img src={facebook} alt="" /></div>
                  <span>Facebook</span>
                </div>
                </a>
              </div>

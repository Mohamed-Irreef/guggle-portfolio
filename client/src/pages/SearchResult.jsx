...
const SearchResult = ({searched,setSearched}) => {
  ...
  const pages = useMemo(() => ["all","about","education","skills","projects","experiences","awards","contact","hire","images","videos","news"], [])
  ...
  return (
    <div className='search-result-page'>
        <SearchResultNav gridOpen={gridOpen} tabChosen={tabChosen} setTabChosen={setTabChosen} setGridOpen={setGridOpen} close={close} page={page} searched={searched} setSearched={setSearched}/>
        {/* {
          !pages.con(page)?
